...
description: AI 分析当前项目结构并生成项目级 AGENTS.md
trigger: /agent-memory:init
---

# /agent-memory:init

分析当前项目，生成项目级 AGENTS.md。
...
### Step 2: 生成项目 AGENTS.md

在 .Codex/AGENTS.md 写入（如已有内容则在开头追加项目信息段落）：

```markdown
# 项目上下文

- **project**: <项目名，从 .Codex/mcp.json 的 args 中获取，或使用目录名>
- **技术栈**: <检测到的语言、框架、数据库等>
- **架构**: <目录结构推断的架构模式>
